...
namespace Assessment07
{
    internal class Program
    {
        ...
        static DataSet ds;
        static string connection = "Server=DESKTOP-QHQ6E5M;database=Assignment;Trusted_Connection=true;";
        ...
        static void Main(string[] args)
        {
            ...
            again:
                ...
                Console.WriteLine("Enter  Operation You would like to Perform");
